...
<head>
   <meta charset="UTF-8">
    <title>Serviços - Casa de Repouso Luz e Vida</title>
    <meta name="title" content="Serviços - Casa de Repouso Luz e Vida">
...
<body>
    ...
    <h1 style="position:absolute;left:-9999px;">Serviços</h1>
...
<main>
	...
	<section class="introducao-container">
        <br><h1 class="introducao-titulo">Serviços</h1>
    </section>

    <!-- Primeiro bloco: texto depois imagem -->
<section class="bloco-img-texto galeria-lightbox">
      <h1 style="position:absolute;left:-9999px;">Paragrafo 1</h1>
...
<section class="bloco-img-texto galeria-lightbox">
          <h1 style="position:absolute;left:-9999px;">Paragrafo 2</h1>
    ...
    <section class="fraseComplemento">
          <h1 style="position:absolute;left:-9999px;">Paragrafo 3</h1>
...
paciente da sua residência gere o menor impacto possível. 
        ...
        <p>
        <strong>    Faça-nos uma visita e conheça mais <a href="quemsomos.php">sobre nós</a></strong>
        </p>
    </section>
